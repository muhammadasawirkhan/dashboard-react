  ...
  return (
     <>
                ...
                <div className='mt-[50px] text-center '>
                    <h1 className='text-[44px]'>Verify Code</h1>
                </div>
    
                <div className='space-y-[10px]'>
                    <div className='mt-[150px] text-center'>
                        <p className='text-[14px] text-[#282828] mr-[260px]'>Verification Code</p>
                        <input type="text" placeholder='Enter your verification code' className='h-[48px] bg-[#FFF4EF] w-[350px] rounded-[8px] pt-[12px] pr-[16px] pb-[12px] pl-[16px] outline-none ' style={{ boxShadow: '0px 2px 5px rgba(0, 0, 0, 0.15)' }} />
                    </div>
